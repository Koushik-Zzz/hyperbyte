...
const Home = ({ text, description }: Props) => {
  return (
    <div className="flex items-center justify-center h-screen w-screen text-center gap-4 flex-col relative">
      ...
      <div className="py-2 px-3 bg-white rounded-md flex items-center gap-2 mt-4 transition-all duration-500 cursor-pointer ease-in-out group">
        ...
        <h1 className="group-hover:ml-8 font-medium text-black text-sm transition-all duration-500 ease-in-out">Book a 15-min call</h1>
      </div>
