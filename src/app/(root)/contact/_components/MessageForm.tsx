...
const MessageForm = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-32 px-10 h-screen">
      ...
      <form className="flex flex-col justify-center items-center gap-8 w-full md:w-[600px]">
        <div className="flex max-md:flex-col items-center gap-8 w-full">
          <div className="border-white px-0 pb-2 border-b w-1/2 max-md:w-full">
            <input
              ...
              className="border-transparent bg-transparent placeholder:font-medium text-medium text-white placeholder:text-white outline-none"
            />
          </div>
          <div className="border-white px-0 pb-2 border-b w-1/2 max-md:w-full">
            <input
        ...
        <div className="border-white md:mt-8 md:ml-8 px-0 pb-2 border-b w-full md:w-[624px]">
          <textarea
            ...
            name="message"
            rows={1}
            className="border-transparent bg-transparent placeholder:font-medium text-medium text-white placeholder:text-white outline-none resize-none"
          />
        </div>
        <button type="submit" className="border-white px-4 py-2 border rounded-[20px] text-base text-white">
          Send Message
        </button>
      </form>
    </div>
